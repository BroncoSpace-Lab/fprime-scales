...
namespace scalesSvc {
    ...
    public InaManagerComponentBase
  {
    ...
    PRIVATE:
      ...
      F32 convertCurrentRawToMilliAmps(I16 raw) const;
      F32 convertVoltageRawToMilliVolts(I16 raw) const;
      F32 convertPowerRawToMilliWatts(I16 raw) const;

      static constexpr U32 INA260_I2C_ADDRESS = 0x40;
